...
f = File.open("reputation_values_for_OSS_with_init_repu_equal_to_one_calculated_by_new_way.txt", "r")
...
f = File.open("[program1]reputation_values_for_OSS_with_init_repu_not_equal_to_one_calculated_by_new_way.txt", "r")

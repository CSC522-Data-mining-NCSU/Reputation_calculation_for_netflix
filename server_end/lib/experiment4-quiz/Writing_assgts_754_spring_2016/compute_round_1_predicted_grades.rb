...
predicted_grades_hamer_repu_round_1 = Hash.new
predicted_grades_lauw_repu_round_1 = Hash.new
...
f = File.open("writing_assgts_round_1_peer_review_records.txt", "r")
...
peer_review_records.each do |submission, value|
	sum_naive_average = 0
	sum_hamer_repu_round_1 = 0
	sum_lauw_repu_round_1 = 0
	weight_naive_average = 0
	weight_hamer_repu_round_1 = 0
	weight_lauw_repu_round_1 = 0
	...
	value.each do |stu, grade|
		...
		if all_reputation_values_available == true
			...
			sum_hamer_repu_round_1 += grade * hamer_repu_round_1[stu]
			weight_hamer_repu_round_1 += hamer_repu_round_1[stu]

			sum_lauw_repu_round_1 += grade * lauw_repu_round_1[stu]
			weight_lauw_repu_round_1 += lauw_repu_round_1[stu]
		end
	end
	...
	predicted_grades_hamer_repu_round_1[submission] = (1.0 * sum_hamer_repu_round_1 / weight_hamer_repu_round_1).round(3)
	predicted_grades_lauw_repu_round_1[submission] = (1.0 * sum_lauw_repu_round_1 / weight_lauw_repu_round_1).round(3)

	peer_grades_for_each_submission = []
end

puts "=====naive_average_round_1==================="
puts predicted_grades_naive_average
puts "=====hamer_repu_round_1==================="
puts predicted_grades_hamer_repu_round_1
puts "=====lauw_repu_round_1==================="
puts predicted_grades_lauw_repu_round_1
puts "=====total_stu_num==================="
